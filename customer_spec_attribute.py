...
def upload_file():
    if 'file' in request.files:
        ...
        df = panda.DataFrame({
            ...
            'data_source': dummy['data_source'],
            'attribute_value_type': dummy['attribute_value_type']
            
        })
        print(df.head)
        df.to_sql(name='customer_specific_attribute',con=engine,if_exists='append',index=False)
